...
#
#  heroku config:set DJANGO_SECRET_KEY='yc7^k!_6x06$c@389m17t)r+0*%sf$-8#c%(dre!4$r%p@(pxv'
# 
# and then read the secret key from the environment variable with:
#  SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY')
#
SECRET_KEY = 'yc7^k!_6x06$c@389m17t)r+0*%sf$-8#c%(dre!4$r%p@(pxv'
...
# if the environment variable is not defined then default to realproject_db.sqlite3.
